...
class MovieDB
{
    ...
    public static void main (String [] args)
    {
        ...
        //Changed 10000.0 to 10000.0F to avoid existing bug.
        ...
        t_join2.print ();
                ...
                //----------------to test range select on MovieStar
        out.println();
        Table t_iselect1 = movieStar.select(new KeyType("Carrie_Fisher"), new KeyType ("Mark_Hamill"));
        t_iselect1.print ();
        
        out.println("testTable i_join");
        Table testTable = movie.i_join("studioName", "name", studio);
        testTable.print ();
        
        out.println("testTable h_join");
        Table testTable1 = movie.h_join("studioName", "name", studio);
        testTable1.print ();
        
        
        //Testing findPrimaryKey method
        String [] test = cinema.findPrimaryKeyForJoin (" year", "movieTitle movieYear starName", starsIn);
